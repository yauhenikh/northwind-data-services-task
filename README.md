...
```
ошибка 7025: Параметр DataServiceCollection не может быть указан, если в качестве Version указано значение по умолчанию "1.0".
```
...
```
ошибка 7001: Элемент "DataService" имеет атрибут "DataServiceVersion" с нераспознанной версией "3.0".
```
